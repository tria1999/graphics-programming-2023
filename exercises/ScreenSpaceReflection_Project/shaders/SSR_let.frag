...
void SSR()
{
    ...
    vec2 texSize  = textureSize(DepthTexture, 0).xy; //this is supposed to be the position texture, look back later
  ...
  FragColor = normalize(texture(DepthTexture,texCoord));
