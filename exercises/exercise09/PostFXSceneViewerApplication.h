...
//temp
/*
    std::shared_ptr<Model> waterModel = loader.LoadShared("models/water/water.obj");
    waterModel->GetMaterial(0).SetUniformValue("ColorTexture", textureLoader.LoadShared("models/water/water.png"));
